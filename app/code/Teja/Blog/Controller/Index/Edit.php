...
class Edit extends Action 
{
    ...
    public function execute()
    {
       ...
       //here we need to connect to the model and load the record based on id
        $this->_displayGroupDataFactory->create()->load($id)->setId($id)->setTitle('helllllo')->save();

        $this->messageManager->addSuccessMessage(__('You updated the Record after adding id/48 in url .'));
